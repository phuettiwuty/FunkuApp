...
// ** 2. นำเข้าหน้า Profile (ต้องมีไฟล์ ProfileScreen.js หรือใส่โค้ดไว้ในนี้) **
    ...
    return (
        <SafeAreaView style={profileStyles.container}>
            ...
            <View style={profileStyles.content}>
                <Text style={profileStyles.text}>นี่คือหน้าจอ Profile ของคุณ</Text>
                <Text style={profileStyles.text}>ใช้ Tab Bar ด้านล่างเพื่อกลับไปหน้า Feed</Text>
            </View>
        </SafeAreaView>
    );
}
...
// ** 4. Component สำหรับหน้า Feed เพลง **
function SongFeedScreen() {
  const [currentIndex, setCurrentIndex] = useState(0);

  // ให้เล่นใน silent ได้ (เหมือนเดิม)
  useEffect(() => {
    (async () => {
...
// ** 5. App Component ถูกเปลี่ยนเป็น Navigation Container หลัก **
...
const styles = StyleSheet.create({
  ...
  sliderBox: {
    position: 'absolute',
    bottom: 200, // <--- **แก้ไข: ปรับให้สูงขึ้น**
    left: 32,
    right: 32,
  },
  timeRow: {
  ...
  heartBox: {
    position: 'absolute',
    bottom: 120, // <--- **แก้ไข: ปรับให้สูงขึ้นเหนือ Tab Bar**
    alignSelf: 'center',
  },
  heart: {
    color: 'white',
